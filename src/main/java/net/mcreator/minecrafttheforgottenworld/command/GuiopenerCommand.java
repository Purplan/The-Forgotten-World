...
public class GuiopenerCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("opengui").requires(s -> s.hasPermission(3)).executes(arguments -> {
			...
			OpenLaunchPadGUIProcedure.execute(world, x, y, z, entity);
			return 0;
		}));
	}
}
